...
import sys
sys.path.append("../")
from parts import target_shapes_sampled_points
...
class StackBoxesEnv3D_multiple_obj_4(StackBoxesEnv3D_multiple_obj):

    '''
    Environment built on top of the one implemented inside fill_volume_env_3D_multiple_obj_3Dac.py - just with 4 sides,...
    '''
    ...
    def __init__(self, num_boxes, visualize=True, seed=None, add_connectivity=False, ensemble=False, env_grid_size=3, fully_connected=True, load_path=None):
        ...
        # remove all cameras, as we want to place them newly
        ...
        if not(ensemble):
            ...
            # we also need to sample 4 sided target shape
