...
from .fill_volume_env_3D_multiple_obj_3Dac_w_robot1 import StackBoxesEnv3D_multiple_obj_w_robot as StackBoxesEnv3D_multiple_obj_w_robot_inherit

class StackBoxesEnv3D_multiple_obj_w_robot(StackBoxesEnv3D_multiple_obj_w_robot_inherit):
    '''
    This environment is built on top of fill_volume_env_3D_multiple_obj_3Dac_more_objects_w_robot1_new.py and
